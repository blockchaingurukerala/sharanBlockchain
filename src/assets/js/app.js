...
function proceesRegistration(){
	var role=$("#RoleSelect").val();
	if(role=="1"){
		window.location.replace("add-healthcare-provider.html");
	}
	if(role=="2"){
		window.location.replace("add-doctor.html");
	}
	if(role=="3"){
		window.location.replace("add-patient.html");
	}
	if(role=="4"){
		window.location.replace("add-insurance-provider.html");
	}
}